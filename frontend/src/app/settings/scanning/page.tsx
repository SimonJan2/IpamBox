      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <SettingField
            ...
            onReset={() => resetKey("scan_networks")}
          ...
          <SettingField
            ...
            onReset={() => resetKey("scan_exclude_networks")}
          ...
          <SettingField
            ...
            onReset={() => resetKey("scan_only_configured")}
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          <SettingField
            ...
            onReset={() => resetKey("scan_interval_minutes")}
          ...
          <SettingField
            ...
            onReset={() => resetKey("scan_min_interval_seconds")}
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <SettingField
            ...
            onReset={() => resetKey("scan_tcp_ports")}
          ...
          {advanced && (
            <div className="grid gap-4 border-l pl-4 sm:grid-cols-3">
              <SettingField
                ...
                onReset={() => resetKey("scan_interface")}
              ...
              <SettingField
                ...
                onReset={() => resetKey("scan_icmp_timeout")}
              ...
              <SettingField
                ...
                onReset={() => resetKey("scan_tcp_timeout")}
              ...
              <SettingField
                ...
                onReset={() => resetKey("scan_concurrency")}
